<div align="center">
    ...
    <img width="100%" alt="img" src="https://almablog-media.s3.ap-south-1.amazonaws.com/If_Else_statements_min_4d68830a8f.png"/>
</div>
...
| [📚] Receba o tipo de investimento, sendo 1 a poupança e 2 a renda fixa, e o valor do investimento. Calcule e mostre o valor corrigido em 30 dias, sabendo que a poupança gera 3% e a renda fixa 5%. Demais tipos de investimentos não serão considerados. | [☕] [Exercicio11.java](https://github.com/KawanSerafim/LP-Java/blob/main/src/main/edu/curso/core/estruturas/logicas/condicional/Exercicio11.java) |
